...
})({"dTSMY":[function(require,module,exports) {
...
var assets = {
    ...
    "bus": new URL(require("667cbb264d87539a"))
};
var assetLoader = new (0, _assetloaderJs.AssetLoader)(assets);
...
class AssetLoader {
    constructor(assets){
        ...
        for(let name in assets)loader.load(assets[name].href, function(gltf) {
            const model = gltf.scene;
            for (let mesh of model.children)if (!("isCamera" in mesh)) {
                mesh.material = new _three.MeshPhysicalMaterial({
            ...
            if (assetLoader.loadCount == 0) assetLoader.onload(assetLoader.assets);
        });
    }
    onload(assets) {}
}
...
},{"three":"ktPTu","three/examples/jsm/loaders/GLTFLoader.js":"dVRsF"}],"dVRsF":[function(require,module,exports) {
...
},{"three":"ktPTu","../utils/BufferGeometryUtils.js":"5o7x9","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"5o7x9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"16C35":[function(require,module,exports) {
module.exports = require("d739bdb0c9ae7348").getBundleURL("eTM5S") + "office.67e76b27.glb" + "?" + Date.now();

},{"d739bdb0c9ae7348":"jMDco"}],"jMDco":[function(require,module,exports) {
"use strict";
var bundleURL = {};
